...
ID=184
TITLE='Protecao dos binarios de auditoria'
...
need_root
for b in auditctl aureport ausearch autrace auditd augenrules; do p=$(command -v "$b") || continue; chown root:root "$p"; chmod go-w "$p"; done
echo "OK"
